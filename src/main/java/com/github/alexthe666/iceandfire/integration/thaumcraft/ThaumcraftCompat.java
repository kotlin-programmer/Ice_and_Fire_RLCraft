...
public class ThaumcraftCompat {
    ...
    public void aspectRegistrationEvent(AspectRegistryEvent evt){
        ...
        for (EnumDragonEgg egg : EnumDragonEgg.values()) {
            if (egg.dragonType == EnumDragonType.FIRE) {
                evt.register.registerObjectTag(new ItemStack(egg.egg), new AspectList().add(ThaumcraftCompat.DRAGON, 5).add(Aspect.FIRE, 5).add(Aspect.DESIRE, 20).add(Aspect.BEAST, 6));
                evt.register.registerObjectTag(new ItemStack(egg.scales), new AspectList().add(ThaumcraftCompat.DRAGON, 5).add(Aspect.FIRE, 5).add(Aspect.DESIRE, 20).add(Aspect.BEAST, 6).add(Aspect.PROTECT, 7));
            } else if (egg.dragonType == EnumDragonType.ICE) {
                evt.register.registerObjectTag(new ItemStack(egg.egg), new AspectList().add(ThaumcraftCompat.DRAGON, 5).add(Aspect.COLD, 5).add(Aspect.DESIRE, 20).add(Aspect.BEAST, 6));
                evt.register.registerObjectTag(new ItemStack(egg.scales), new AspectList().add(ThaumcraftCompat.DRAGON, 5).add(Aspect.COLD, 5).add(Aspect.DESIRE, 20).add(Aspect.BEAST, 6).add(Aspect.PROTECT, 7));
            }
        }
        ...
        evt.register.registerObjectTag(new ItemStack(IafItemRegistry.troll_leather_mountain), new AspectList().add(Aspect.BEAST, 10).add(ThaumcraftCompat.MYTHICAL, 10).add(Aspect.PROTECT, 5).add(Aspect.DESIRE, 2).add(Aspect.MAGIC, 5).add(Aspect.ENTROPY, 5).add(Aspect.EARTH, 7));
        evt.register.registerObjectTag(new ItemStack(IafItemRegistry.troll_leather_frost), new AspectList().add(Aspect.BEAST, 10).add(ThaumcraftCompat.MYTHICAL, 10).add(Aspect.PROTECT, 5).add(Aspect.DESIRE, 2).add(Aspect.MAGIC, 5).add(Aspect.ENTROPY, 5).add(Aspect.COLD, 7));
        evt.register.registerObjectTag(new ItemStack(IafItemRegistry.troll_leather_forest), new AspectList().add(Aspect.BEAST, 10).add(ThaumcraftCompat.MYTHICAL, 10).add(Aspect.PROTECT, 5).add(Aspect.DESIRE, 2).add(Aspect.MAGIC, 5).add(Aspect.ENTROPY, 5).add(Aspect.PLANT, 7));
