...
public class IafVillagerRegistry {
	...
	public void init() {
		...
		craftsman = new VillagerRegistry.VillagerProfession("iceandfire:craftsman", "iceandfire:textures/models/snowvillager/craftsman.png", "minecraft:textures/entity/zombie_villager/zombie_farmer.png");
		{
			...
			career.addTrade(3, new ListItemForSapphires(IafItemRegistry.troll_leather_frost, new EntityVillager.PriceInfo(1, 5)));
		...
		shaman = new VillagerRegistry.VillagerProfession("iceandfire:shaman", "iceandfire:textures/models/snowvillager/shaman.png", "minecraft:textures/entity/zombie_villager/zombie_farmer.png");
		{
			...
			career.addTrade(2, new ListItemForSapphires(IafItemRegistry.wither_shard, new EntityVillager.PriceInfo(2, 3)));
			register(shaman, 2);
		}
		...
		desertMyrmexRoyal = new VillagerRegistry.VillagerProfession("iceandfire:desertMyrmexRoyal", "minecraft:textures/entity/zombie_villager/zombie_farmer.png", "minecraft:textures/entity/zombie_villager/zombie_farmer.png");
		{
			...
			career.addTrade(2, new EntityMyrmexBase.BasicTrade(new ItemStack(Items.GOLD_INGOT), new ItemStack(IafItemRegistry.myrmex_desert_resin), new EntityVillager.PriceInfo(2, 4), new EntityVillager.PriceInfo(2, 4)));
			career.addTrade(2, new EntityMyrmexBase.BasicTrade(new ItemStack(IafItemRegistry.silverIngot), new ItemStack(IafItemRegistry.myrmex_desert_resin), new EntityVillager.PriceInfo(2, 4), new EntityVillager.PriceInfo(2, 4)));
		...
		jungleMyrmexRoyal = new VillagerRegistry.VillagerProfession("iceandfire:jungleMyrmexRoyal", "minecraft:textures/entity/zombie_villager/zombie_farmer.png", "minecraft:textures/entity/zombie_villager/zombie_farmer.png");
		{
			...
			career.addTrade(2, new EntityMyrmexBase.BasicTrade(new ItemStack(Items.GOLD_INGOT), new ItemStack(IafItemRegistry.myrmex_jungle_resin), new EntityVillager.PriceInfo(2, 4), new EntityVillager.PriceInfo(2, 4)));
			career.addTrade(2, new EntityMyrmexBase.BasicTrade(new ItemStack(IafItemRegistry.silverIngot), new ItemStack(IafItemRegistry.myrmex_jungle_resin), new EntityVillager.PriceInfo(2, 4), new EntityVillager.PriceInfo(2, 4)));
