...
public enum EnumDragonArmor {
	...
	public static void initArmors() {
		for (int i = 0; i < EnumDragonArmor.values().length; i++) {
			EnumDragonArmor.values()[i].armorMaterial = EnumHelper.addArmorMaterial("DragonScales" + (i + 1), "iceandfire:armor_dragon_scales" + (i + 1), 40, new int[]{5, 7, 9, 5}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 2);
